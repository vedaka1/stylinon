...
class DuplicateOrderPositionsException(ApplicationException):
    ...
    def __init__(self, product_id: UUID, *args: object):
        self.message = f"Duplicate order positions are not allowed. Product with id {product_id} is already in the order"
